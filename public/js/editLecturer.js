...
registerForm.addEventListener('submit', (e) => {
     ...
     const lecturerId = registerForm.lecturerId.value;
     ...
     const data = {lecturerId, fullname, email, phone_no, reg_no, gender, faculty, dept, session, level}


     fetch('/admin/edit-lecturer', {
